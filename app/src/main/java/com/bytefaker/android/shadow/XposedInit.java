package com.bytefaker.android.shadow;
...
import com.bytefaker.android.shadow.callbacks.XC_InitPackageResources;
import com.bytefaker.android.shadow.callbacks.XC_LoadPackage;
import com.bytefaker.android.shadow.callbacks.XCallback;
import com.bytefaker.android.shadow.services.BaseService;

import static com.bytefaker.android.shadow.XposedBridge.hookAllConstructors;
import static com.bytefaker.android.shadow.XposedBridge.hookAllMethods;
import static com.bytefaker.android.shadow.XposedHelpers.callMethod;
import static com.bytefaker.android.shadow.XposedHelpers.closeSilently;
import static com.bytefaker.android.shadow.XposedHelpers.fileContains;
import static com.bytefaker.android.shadow.XposedHelpers.findAndHookMethod;
import static com.bytefaker.android.shadow.XposedHelpers.findClass;
import static com.bytefaker.android.shadow.XposedHelpers.findFieldIfExists;
import static com.bytefaker.android.shadow.XposedHelpers.getBooleanField;
import static com.bytefaker.android.shadow.XposedHelpers.getObjectField;
import static com.bytefaker.android.shadow.XposedHelpers.getOverriddenMethods;
import static com.bytefaker.android.shadow.XposedHelpers.getParameterIndexByType;
import static com.bytefaker.android.shadow.XposedHelpers.setObjectField;
import static com.bytefaker.android.shadow.XposedHelpers.setStaticBooleanField;
import static com.bytefaker.android.shadow.XposedHelpers.setStaticLongField;
import static com.bytefaker.android.shadow.XposedHelpers.setStaticObjectField;
...
/*package*/ final class XposedInit {
	...
	private static final String INSTALLER_PACKAGE_NAME = "com.bytefaker.android.shadow.installer";
	 ...
	 * in <code>assets/shadow_init</code>.
	 */
	private static void loadModule(String apk, ClassLoader topClassLoader) {
		...
		try {
			...
			ZipEntry zipEntry = zipFile.getEntry("assets/shadow_init");
			if (zipEntry == null) {
				Log.e(TAG, "  assets/shadow_init not found in the APK");
				closeSilently(zipFile);
				return;
			}
			is = zipFile.getInputStream(zipEntry);
		} catch (IOException e) {
			Log.e(TAG, "  Cannot read assets/shadow_init in the APK", e);
			closeSilently(zipFile);
			return;
		}
